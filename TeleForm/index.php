      ...
      <form id="teleform" class="glass p-8 rounded-2xl shadow-2xl space-y-10 text-black" action="result.php" method="POST">
        ...
        <div class="bg-white rounded-xl shadow p-6 space-y-4">
          ...
          <div class="space-y-2">
            ...
            <label class="flex items-start space-x-2">
              <input type="checkbox" name="tools[]" value="สอน.บัดดี้" class="mt-1">
              <span>สอน.บัดดี้</span>
            </label>
            <label class="flex items-start space-x-2">
        ...
        <div class="bg-white rounded-xl shadow p-6 space-y-4">
          ...
          <div class="flex flex-col gap-2">
            <label><input type="checkbox" name="service_type[]" value="B2B" class="mr-2">B2B (รพ. กับ รพ. หรือ รพ. กับ รพ.สต.)</label>
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="mt-2">
              ...
              <div class="flex flex-col gap-2 pl-4">
                <label class="flex items-start space-x-2">
                  <input type="checkbox" name="b2b_partner[]" value="รพ.สต" class="mt-1">
                  <span>รพ.สต</span>
                </label>
                <label class="flex items-start space-x-2">
                  <input type="checkbox" name="b2b_partner[]" value="เรือนจำ" class="mt-1">
                  <span>เรือนจำ</span>
                </label>

                <label class="flex items-center">
                  <input type="checkbox" name="b2b_partner" id="b2bOtherRadio" value="อื่นๆ" class="mr-2">อื่นๆ
        ...
        <div class="bg-white rounded-xl shadow p-6 space-y-4">
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="flex items-center space-x-2">
              <label class="flex items-center">
                <input type="checkbox" id="volunteerCheckbox" name="drug_delivery_type[]" value="ส่งให้ อสม." class="mr-2"> ส่งให้ อสม.
              </label>
            </div>
        ...
        <div class="bg-white rounded-xl shadow p-6 space-y-4">
          <h3 class="text-xl font-semibold text-blue-800 border-b pb-2">
            11. มีการให้บริการนัดหมายออนไลน์ในจุดบริการ หรือ คลินิกใดบ้าง
        ...
        <!-- 12.ในการให้บริการ Telemedicine มีการใช้ PHR View ร่วมด้วยหรอไม่ -->
        <div class="bg-white rounded-xl shadow p-6 space-y-4">
          <h3 class="text-xl font-semibold text-blue-800 border-b pb-2">
            12.ในการให้บริการ Telemedicine มีการใช้ PHR View ร่วมด้วยหรอไม่<span class="text-red-500">*</span>
          </h3>
          <div class="flex flex-col gap-2">
            <div class="grid grid-cols-1 gap-2">
        ...
        <!-- 13. จากการที่ทางโรงพยาบาลได้ให้บริการ Telemedicine / Telehealth ท่านคิดว่าผู้รับบริการได้รับประโยชน์อะไร / อย่างไรบ้าง-->
        <div class="bg-white rounded-xl shadow p-6 space-y-4">
          <h3 class="text-xl font-semibold text-blue-800 border-b pb-2">
            13. จากการที่ทางโรงพยาบาลได้ให้บริการ Telemedicine / Telehealth ท่านคิดว่าผู้รับบริการได้รับประโยชน์อะไร / อย่างไรบ้าง <span class="text-red-500">*</span>
          </h3>
          <div class="flex flex-col gap-2">
            <div class="flex items-center space-x-2 w-full">
...
<script>
  document.addEventListener("DOMContentLoaded", () => {
    const mappings = [{
        checkboxId: 'healthRiderCheckbox',
        inputId: 'health_rider_count'
      },
      {
        checkboxId: 'postalCheckbox',
        inputId: 'postal_count'
      },
    ...
    const questionMap = {
      ...
      "8-11. ระบบนัดหมายออนไลน์": {
        online_appointment_system: "8. มีระบบนัดหมายออนไลน์หรือไม่",
        program_meet: "9. โปรแกรมที่ใช้",
        appointment_count: "10. จำนวนการนัดหมาย",
        server_location: "11. จุดบริการที่ใช้ระบบนัดหมายออนไลน์"
      },
      "12-13. อื่น ๆ": {
        phr_view_usage: "12. ใช้ PHR View หรือไม่",
        beneficiary_benefits: "13. ประโยชน์ต่อผู้รับบริการ"
      }
    };
...
`;
      ...
      if (result.isConfirmed) {
        ...
        try {
          ...
          // อ่าน Response Body เป็น JSON เพียงครั้งเดียว
          ...
          Swal.fire('เกิดข้อผิดพลาดในการเชื่อมต่อ!', 'โปรดลองอีกครั้งในภายหลัง: ' + error.message, 'error');
        }
      }
    });
